...
import { PointDeVente } from '../TableStickyHeader'
...
const InfoPDV = ({ PDV, showPDV, setShowPDV }: InfoMarshandiserProps) => {
  // ** States
  ...
  return (
    <Drawer
      open={showPDV} // Contrôle l'ouverture et la fermeture du Drawer
    ...
    >
      <div>
        <Header>
          ...
          <PageHeader title={<Typography variant='h1'>Détails & Informations</Typography>} />
          <IconButton
            size='small'
            onClick={handleClose}
            sx={{
        ...
        <Box marginLeft={6}>
          <Grid container spacing={6}>
            <Grid item sm={6} xs={12} sx={{ paddingRight: '16px' }}>
              <CustomTextField fullWidth label='Nom' placeholder='Nom' value={PDV?.nom || ''} />
            </Grid>
            <Grid item sm={6} xs={12} sx={{ paddingRight: '16px' }}>
              <CustomTextField
                fullWidth
                ...
                value={PDV?.localisation || ''}
              />
            </Grid>
            <Grid item sm={6} xs={12} sx={{ paddingLeft: '16px' }}>
              <CustomTextField fullWidth label='Ville' placeholder='Ville' value={PDV?.ville || ''} />
            </Grid>
            <Grid item sm={6} xs={12} sx={{ paddingRight: '16px' }}>
              <CustomTextField fullWidth label='Enseigne' placeholder='Enseigne' value={PDV?.enseigne || ''} />
            </Grid>
          </Grid>
        </Box>
      </div>
